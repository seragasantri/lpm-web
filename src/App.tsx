...
import HalamanIndex from './admin/pages/halaman/index';
import HalamanSlug from './admin/pages/halaman/[slug]';
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin" element={<ProtectedRoute><AdminLayout /></ProtectedRoute>}>
          ...
          <Route path="halaman" element={<HalamanIndex />} />
          <Route path="halaman/:slug" element={<HalamanSlug />} />
